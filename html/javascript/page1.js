const p = document.getElementById('super');
setInterval(()=>{p.click()},5000);


const aboutus_website = document.getElementById('a');
aboutus_website.addEventListener('click',function(){
  window.open('about-us-1.html','_blank');
});
